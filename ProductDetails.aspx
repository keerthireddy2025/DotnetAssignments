<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductDetails.aspx.cs" Inherits="Dotnet1.ProductDetails" %>
...
<body>
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control" id="productQuantity" placeholder="Select Quantity" name="productQuantity" />
    </div>
